...
const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    subtitle: "Local partnerships turn your gym into a community health hub — driving referrals, retention, and brand authority.",
    icon: Handshake,
    category: "Acquisition",
    phases: [
      {
        title: "Identifying Partners",
        summary: "Look for organizations whose members would naturally benefit from what you offer, align with your ideal member and strengthen your retention ecosystem.",
        details: [
          "List 5-10 local organizations that serve the same demographic you want more of: businesses, schools, first responder stations, sports clubs, churches, physical therapy offices, real estate groups.",
          "Prioritize partners whose audience overlaps with your ideal member profile — active adults, professionals, families, or performance-minded individuals.",
          "Think about what you can offer them, not just what they can give you. A partnership should be mutually beneficial.",
          "Start with one or two partners. Validate referral volume, close rate, and 90-day retention before expanding.",
        ],
      },
      {
        title: "Making the Connection",
        summary: "Lead with value and create a structured, trackable partnership — not a vague handshake agreement.",
        details: [
          "Offer a high-value introduction experience: a hosted team workout, injury prevention seminar, nutrition workshop, or private fundamentals class.",
          "Create a simple, trackable co-branded offer: 'Show your [partner] badge for a free week' or 'Mention [partner] for 10% off your first month.'",
          "Establish a quarterly activation cadence: co-host an event, educational night, charity workout, or employee wellness challenge.",
          "Build the relationship directly with the decision-maker. Assign a staff owner internally to maintain and grow each partnership.",
        ],
      },
      {
        title: "Converting & Tracking",
        summary: "Measure partnership performance based on revenue and retention impact, not visibility.",
        details: [
          "Convert every referred contact into a scheduled No Sweat Intro within 24 hours — speed to lead directly impacts close rate.",
          "Track new members per partner, close rate of partner referrals, and 90-day retention compared to gym average.",
          "Measure ARM and Lifetime Value of partner-referred members to determine true partnership ROI.",
          "Review partnership performance quarterly. Scale high-performing relationships and sunset partnerships that do not produce measurable outcomes.",
        ],
      },
    ],
  },
